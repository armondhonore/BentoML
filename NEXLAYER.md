...
**Live:** [https://relaxed-weasel-bentoml.cloud.nexlayer.ai](https://relaxed-weasel-bentoml.cloud.nexlayer.ai)  
...
**bentoml** is deployed on [Nexlayer](https://nexlayer.ai) — a container-native
...
application:
  ...
  pods:
  - name: app
    image: "registry.nexlayer.io/user_01kece1xyh817dwff7wnarhkxd/bentoml:19f1523c6ca"
    path: /
    servicePorts:
    - 3000
```
